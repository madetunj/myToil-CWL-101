...
doc: |
  Workflow performs Peak Calls from `bamfile` input using MACSv1 on single-end (SE) reads.
  In addition MOTIFs (Enriched and Discovered) are called using the MEME-suite (AME & MEMe-chip)
